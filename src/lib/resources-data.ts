...
export const resources: Resource[] = [
  ...
  {
    id: 'healthy-pipeline',
    title: 'Pipeline Generation vs Coverage',
    description: 'The mechanics of a healthy pipeline — how much you need flowing in (generation) versus standing at any moment (coverage), and how to tell if your funnel is balanced.',
    functions: ['GTM Strategy', 'Sales', 'Revenue Operations'],
    type: 'guide',
    internalLink: '/resources/pipeline-coverage',
    linkLabel: 'Read the article',
    tags: ['pipeline', 'coverage', 'generation', 'forecast', 'sales', 'gtm', 'revenue'],
  },
  {
  ...
  },
  {
    ...
    title: 'Building a Partner Enablement Program',
    description: 'What to consider when building a structured partner program — partner types and economics, a phased rollout, tailoring by partner type, and the operating cadence that makes it stick.',
    functions: ['Cross-Functional', 'Sales'],
    type: 'guide',
    internalLink: '/resources/partner-enablement',
    linkLabel: 'Read the article',
    tags: ['partner', 'channel', 'enablement', 'reseller', 'program', 'co-sell'],
  },
  {
    id: 'saas-value-map',
